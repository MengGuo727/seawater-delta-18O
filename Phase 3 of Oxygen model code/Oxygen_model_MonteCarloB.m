...
data = load('out_oxygenmodel_0.dat');
...
% 28.n, 29.alpha_HT, 30.theta_LT, 31.theta_MT, 32.theta_HT,
% 33.misfit_Delta17O_phanerozoic1
...
misfit_Delta17O_phanerozoic1 = data(:,33);
...
for i = 1:ndata
    if (misfit_Mf(i)<crit_misfit1 && ...
            misfit_deltaO_lateArchean(i)<5 && ...
            misfit_deltaO_phanerozoic1(i)<5 && ...
            misfit_deltaO_phanerozoic2(i)<crit_misfit2 && ...
            misfit_deltaO_phanerozoic3(i)<5 && ...
            misfit_Delta17O_phanerozoic1(i)< crit_misfit2)
        ...
        '%6g %6g %6g %6g %6g \n'], ...
            ...
            success_oxygen(j,29),success_oxygen(j,30), success_oxygen(j,31), success_oxygen(j,32), success_oxygen(j,33));
